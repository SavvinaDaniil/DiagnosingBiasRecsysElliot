...
def process_synthetic():
    ...
    algorithm = 'DMF'
    batch_size = 1024
    fairbook_ratings = pd.read_csv("data/fairbook/fairbook_events.csv")
    for d in range(len(data_strategies)):
        
        data = data_strategies[d]
        print(data)
        alt_data = alt_data_strategies[d]
        ...
        for fold in range(1,6):
            # Set locations of recommendations and best iteration files
            recs_location = 'results/'+alt_data+str(fold)+'/recs/'
            best_iter_location = 'results/'+alt_data+str(fold)+'/performance/'
        ...
        for mlp in mlp_values:
            ...
            for fold in tqdm(range(1,6)):
                # Train and test files of that fold
                train_file = 'data/'+alt_data+str(fold)+'/'+data+'_fold_'+str(fold)+'_train.csv'
                test_file = 'data/'+alt_data+str(fold)+'/'+data+'_fold_'+str(fold)+'_test.csv'
